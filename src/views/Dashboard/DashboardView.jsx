...
import highChartInit from './hichart';
        ...
        <div>
              ...
              <GridItem xs={12} sm={6} md={3}>
                 <Card>
                    <CardHeader color="warning" stats icon>
                       ...
                       <p className={classes.cardCategory}>{dashboardData.used_space.header}</p>
                       <h3 className={classes.cardTitle}>
                          {dashboardData.used_space.spaceUsed}/{dashboardData.used_space.spaceAvailable}
                          <small> {dashboardData.used_space.units}</small>
                       </h3>
                    </CardHeader>
                    <CardFooter stats>
                       <div className={classes.stats}>
                          ...
                          <a href="#pablo" onClick={this.addSpace}>
                             Get more space
                          </a>
                       </div>
                    </CardFooter>
              ...
              <GridItem xs={12} sm={6} md={3}>
                 <Card>
                    <CardHeader color="success" stats icon>
                       ...
                       <h3 className={classes.cardTitle}>{dashboardData.revenue.currencySymbol}{dashboardData.revenue.value}</h3>
                    </CardHeader>
                    <CardFooter stats>
                       <div className={classes.stats}>
                          <DateRange />
                          Last 24 Hours
                          <Button variant="contained" color="primary" onClick={this.increaceRevenue}>Increase revenue</Button>
                       </div>
                    </CardFooter>
                 </Card>
              </GridItem>
           ...
           <GridContainer>
              <GridItem xs={12} sm={12} md={12}>
                 <Card>
                    <CardHeader color="warning">
                       <h4>HiChart Example</h4>
                    </CardHeader>
                    <CardBody id="highcharts_demo" />
                 </Card>
              </GridItem>
           </GridContainer>
        </div>
